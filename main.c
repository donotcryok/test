...
int main() {
 ...
 python3 ../cally.py a-main.c.245r.expand| dot -Grankdir=LR -Tpng -o full_call_graph.png
a-main.c.245r.expand
python3 ~/桌面/cally-master/cally.py a-main.c.245r.expand | dot -Grankdir=LR -Tpng -o full_call_graph.png
ls ~/桌面/cally-master/
cd~/桌面
